...
public class TelepotingParticles {
	...
	public TelepotingParticles(Plugin plugin){
		this.plugin = plugin;
	}
	public static void TeleportAway(Player player){
		Location loc = player.getLocation();
		if(plugin.getConfig().getBoolean("Settings.WarpExplotion")){
	...
	public static void Sparkles(Player player){
	...
	public static void RainbowCloud(Player player){
		Random r = new Random();
		int color1 = r.nextInt(255);
		int color2 = r.nextInt(255);
		int color3 = r.nextInt(255);
